...
function Nav3() {
    ...
    return (
        <nav className="nav2">
            ...
            <ul>
                <li><ActiveLink href="/account3">Account</ActiveLink></li>
                <li><ActiveLink href="/profile3">Profile and settings</ActiveLink></li>
                <li><ActiveLink href="/payments3">Payments</ActiveLink></li>
                <li><ActiveLink href="/loan3">Loan</ActiveLink></li>
                <li><ActiveLink href="/security3">Security</ActiveLink></li>
                <li><ActiveLink href="/setup3">Setup wizard</ActiveLink></li>
            </ul>
